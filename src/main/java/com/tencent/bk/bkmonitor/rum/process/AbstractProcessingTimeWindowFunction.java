...
abstract class AbstractProcessingTimeWindowFunction<K, E, A, O>
  ...
  private transient QpsMetrics outputQps;
  private transient Counter windowOpensCounter;
  ...
  public final void open(OpenContext openContext) throws Exception {
    ...
    inputQps = QpsMetrics.register(getRuntimeContext(), "input");
    outputQps = QpsMetrics.register(getRuntimeContext(), "output");
    windowOpensCounter = getRuntimeContext().getMetricGroup().counter("window_opens");
