...
final class RumEventClassification {
  ...
  static int classify(RumEvent event, @Nullable Map<String, Object> attributes) {
  ...
  static boolean isAction(int classification) {
    return contains(classification, ACTION);
  }

  static boolean isResource(int classification) {
    return contains(classification, RESOURCE);
  }

  static boolean isError(int classification) {
    return contains(classification, ERROR);
  }

  static boolean isRequest(int classification) {
    return contains(classification, REQUEST);
  }

  static boolean isRequestError(int classification) {
    return contains(classification, REQUEST_ERROR);
  }

  static boolean isLongTask(int classification) {
    return contains(classification, LONG_TASK);
  }

  static boolean isFrustration(int classification) {
